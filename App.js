...
ReactDOM.render(<App/>, document.getElementById('application-root'));
    ...
    const contact =(
        <div>
            <section id="Contact-section">
            <img href="https://ia.media-imdb.com/images/M/MV5BMTY5NzE3NzU3MF5BMl5BanBnXkFtZTgwMjg0NTQ5MDE@._V1_UX214_CR0,0,214,317_AL_.jpg" alt='an image of sally' />
            <p>My contact information: </p>
            <address id="Contact-info">
                <p>My name is Sally</p>
                <p>My email is: <a href="mailto://sally@IntenetExplorer.old">sally@IntenetExplorer.old</a></p>
    ...
    return <div><header>{introduction}</header><main>{education}{works}{contact}</main></div>
    */